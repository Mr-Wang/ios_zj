...
-(instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        //设置默认背景图片
        [addBtn setBackgroundImage:[UIImage imageNamed:@"tab_ksdk"] forState:UIControlStateNormal];
        //设置按下时背景图片
        [addBtn setBackgroundImage:[UIImage imageNamed:@"tab_ksdk"] forState:UIControlStateHighlighted];
        //添加响应事件
