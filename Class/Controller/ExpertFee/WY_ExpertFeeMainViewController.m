//
//  WY_ExpertFeeMainViewController.m
...
@interface WY_ExpertFeeMainViewController ()
...
@implementation WY_ExpertFeeMainViewController
...
//    self.titleArr =@[@"全部",@"待结算",@"结算中",@"已结算",@"异议中"];
    //2022-05-05 会议 去掉异议
    self.titleArr =@[@"全部",@"待结算",@"结算中",@"已结算"];
...
//    self.selZJIndex = index;
    WY_ExpertFeeListViewController<ZJScrollPageViewChildVcDelegate> *fourview = (WY_ExpertFeeListViewController *)reuseViewController;
     if (!fourview) {
         fourview = [[WY_ExpertFeeListViewController alloc] init];
     }
