...
@interface WY_ZJPushMsgViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_ZJPushMsgViewController
...
- (void)dataSourceIndex{
    ...
    NSString *idcard = self.mUser.idcardnum;
    [[MS_BasicDataController sharedInstance] postWithURL:zj_getTsList_HTTP params:@{@"idcard":idcard} jsonData:[postDic yy_modelToJSONData] showProgressView:YES success:^(id successCallBack) {
