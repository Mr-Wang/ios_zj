//
//  WY_AnnouncementViewController.m
...
#import "WY_AnnouncementViewController.h"
#import "WY_MessageModel.h"
#import "WY_MessageTableViewCell.h"
#import "WY_MesDelViewController.h"
#import "EmptyView.h"

@interface WY_AnnouncementViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_AnnouncementViewController
...
- (void)dataSourceIndex{
    ...
    if (self.idx == 0) {
        [postDic setObject:@"0" forKey:@"isread"];

    } else {
        [postDic setObject:@"" forKey:@"isread"];
    }
    
    [[MS_BasicDataController sharedInstance] postWithURL:getTslb_HTTP params:nil jsonData:[postDic yy_modelToJSONData] showProgressView:YES success:^(id successCallBack) {
        
        if (((NSArray *)successCallBack).count > 0) {
            self.arrDataSource = [NSArray yy_modelArrayWithClass:[WY_MessageModel class] json:successCallBack];
              self.emptyView.hidden = YES;
        } else {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WY_MessageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WY_MessageTableViewCell"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    WY_MessageTableViewCell *cell = [self tableView:tableView cellForRowAtIndexPath:indexPath];
    WY_MessageModel *tempModel = self.arrDataSource[indexPath.row];
    [cell showCellByItem:tempModel];
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        [_tableView registerClass:[WY_MessageTableViewCell class] forCellReuseIdentifier:@"WY_MessageTableViewCell"];
