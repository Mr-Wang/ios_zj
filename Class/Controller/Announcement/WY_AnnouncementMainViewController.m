//
//  WY_AnnouncementMainViewController.m
...
#import "WY_AnnouncementMainViewController.h"

#import "ZJScrollPageView.h"//选择控制器]
#import "WY_AnnouncementViewController.h"

@interface WY_AnnouncementMainViewController ()
...
@implementation WY_AnnouncementMainViewController
...
//    self.selZJIndex = index;
     WY_AnnouncementViewController<ZJScrollPageViewChildVcDelegate> *fourview = (WY_AnnouncementViewController *)reuseViewController;
     if (!fourview) {
         fourview = [[WY_AnnouncementViewController alloc] init];
     }
