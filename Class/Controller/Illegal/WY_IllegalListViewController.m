//
//  WY_IllegalListViewController.m
...
@interface WY_IllegalListViewController ()
...
@implementation WY_IllegalListViewController
...
- (void)dataSourceIndex{
    ...
    //奖励加分列表
    [[MS_BasicDataController sharedInstance] getWithReturnCode:zj_getIllegalIdcard_HTTP params:postDic jsonData:nil showProgressView:YES success:^(id res, NSString *code) {
        NSLog(@"获取数据成功");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell showCellLLByItem:tempModel];
