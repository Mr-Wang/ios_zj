...
@interface WY_CAPayViewController ()
{
    UILabel *lblTLq1;
    UILabel *lblTLqBZ;
    UILabel *lblTLqName;
...
@implementation WY_CAPayViewController
@synthesize viewSel3Yj,viewSel4Lq,viewSel4ALqCity,viewSel5PayType,viewSel6Fp,btnTFp3,lblTFp2,lblTFp1;
...
- (void)lqDataBind {
    if (self.btnSY.selected) {
        ...
        [lblTLqBZ setText:self.dicPostCAInfo[@"dicCAInfo"][@"lqbz1"]];
        [lblTLqGs setText:[NSString stringWithFormat:@"联系单位：%@",self.dicPostCAInfo[@"dicCAInfo"][@"lqdw1"]]];
        [lblTLqAddress setText:@"领取地址："];
        [lblTLqAddress1 setText:self.dicPostCAInfo[@"dicCAInfo"][@"lqdz1"]];
        [lblTLqName setText:[NSString stringWithFormat:@"联 系 人 ：%@",self.dicPostCAInfo[@"dicCAInfo"][@"lqlxr1"]]];
        [lblTLqPhone setText:@"联系电话："];
        NSMutableArray *lqdhs = [[NSMutableArray alloc] initWithArray:[self.dicPostCAInfo[@"dicCAInfo"][@"lqdh1"] componentsSeparatedByString:@"，"]];
        NSString *lqdhsStr = [lqdhs componentsJoinedByString:@"\n"];
        [lblTLqPhone1 setText:lqdhsStr];
    }
...
- (void)initMiddleView {
    ...
    [imgukey setFrame:CGRectMake(viewSel1.width - k360Width(75+16), lblT2.top, k360Width(75), k360Width(35))];
    ...
    [lblGLPTB setText:self.dicPostCAInfo[@"dicCAInfo"][@"glpt"]];
//    [lblGLPTB setText:@"辽宁建设工程信息网、辽宁政府采购网、朝阳市公共资源交易平台"];
    ...
    [self.lblT4 setFrame:CGRectMake(k375Width(16), lblGLPTB.bottom, kScreenWidth - k375Width(10), k375Width(44))];
    ...
    [self.lblT3 setText:self.dicPostCAInfo[@"dicCAInfo"][@"sqjg"]];
    
    
    NSMutableAttributedString *moneyStr = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"金      额：%.2f元\n有 效 期 ：自数字证书(CA)制作之日起一年内有效",[self.dicPostCAInfo[@"dicCAInfo"][@"money"] floatValue]]];
   ...
   [viewSel4ALqCity setFrame:CGRectMake(0, viewSel2.bottom + k375Width(5), kScreenWidth, k375Width(90))];
   ...
   lblTLqGs = [UILabel new];
    ...
    [btnLqPhone setBlockForControlEvents:UIControlEventTouchUpInside block:^(id  _Nonnull sender) {
        ...
        if(self.btnSY.selected) {
            lqdhs = [[NSMutableArray alloc] initWithArray:[self.dicPostCAInfo[@"dicCAInfo"][@"lqdh"] componentsSeparatedByString:@"，"]];
        } else {
            lqdhs = [[NSMutableArray alloc] initWithArray:[self.dicPostCAInfo[@"dicCAInfo"][@"lqdh1"] componentsSeparatedByString:@"，"]];
        }
...
- (void)btnSubmitAction {
    ...
    [postDic setObject:[self.dicPostCAInfo objectForKey:@"exportType"] forKey:@"exportType"];
...
//        [postDic setObject:@"" forKey:@"cityCode"];
    ...
    [[MS_BasicDataController sharedInstance] postWithReturnCode:zj_createDD_HTTP params:nil jsonData:[postDic mj_JSONData] showProgressView:YES success:^(id res, NSString *code) {
