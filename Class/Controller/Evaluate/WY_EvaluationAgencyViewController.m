//
//  WY_EvaluationAgencyViewController.m
...
@interface WY_EvaluationAgencyViewController ()
{
    int lastY;
}
...
@implementation WY_EvaluationAgencyViewController
...
- (void) makeUI {
    ...
    [self.mScrollView addSubview:self.lbl1];
    [self.mScrollView addSubview:self.lbl2];
    [self.mScrollView addSubview:self.lbl3];
    [self.mScrollView addSubview:self.lbl4];
    
//    [self.mScrollView addSubview:self.starRating1];
//    [self.mScrollView addSubview:self.starRating2];
//    [self.mScrollView addSubview:self.starRating3];
//    [self.mScrollView addSubview:self.starRating4];
//    [self.mScrollView addSubview:self.starRating5];
//    [self.mScrollView addSubview:self.starRating6];
...
//    [self  byReturnColCellTitle:@"项目名称：" byLabelStr:@"项目名称项目名称项目名称项目名称项目名称项目名称项目名称项目名称项目名称项目名称项目名称项目名称" isAcc:NO withBlcok:nil];
    ...
    [self byReturnColCellTitle:@"公司形象" byStar:self.starRating1 isAcc:NO withBlcok:nil];
    [self byReturnColCellTitle:@"评标现场组织能力" byStar:self.starRating2 isAcc:NO withBlcok:nil];
    [self byReturnColCellTitle:@"对所评项目业务掌握能力" byStar:self.starRating3 isAcc:NO withBlcok:nil];
    [self byReturnColCellTitle:@"服务态度" byStar:self.starRating4 isAcc:NO withBlcok:nil];
    [self byReturnColCellTitle:@"工作效率" byStar:self.starRating5 isAcc:NO withBlcok:nil];
    
    
    UIView *viewPjBg = [UIView new];
    [viewPjBg setFrame:CGRectMake(k360Width(16), lastY, kScreenWidth - k360Width(32), k360Width(280))];
    ...
    [imgEdit setFrame:CGRectMake(k360Width(32), lastY + k360Width(16), k360Width(17), k360Width(17))];
    ...
    [lblEdit setText:@"您已参加项目，快来评价吧..."];
    [lblEdit setFont:WY_FONT375Regular(14)];
    [lblEdit setTextColor:HEXCOLOR(0xC9C9C9)];
    [self.mScrollView addSubview:lblEdit];
     
    [self.txtContent setFrame:CGRectMake(k360Width(32), lblEdit.bottom + k360Width(16), kScreenWidth -k360Width(64) , k360Width(80))];
    [self.txtContent setPlaceholder:@"请输入评价内容"];
    [self.txtContent setBackgroundColor:HEXCOLOR(0xfafafa)];
    [self.txtContent setFont:WY_FONTRegular(14)];

    
    [self.scrollViewZgzs setFrame:CGRectMake(k360Width(16), self.txtContent.bottom  + k360Width(16), kScreenWidth - k360Width(32), k375Width(120))];
    self.arrZgzs = [[NSMutableArray alloc] initWithArray:[self.qualificationEleId componentsSeparatedByString:@","]];
    ...
    [self byReturnColCellTitle:@"综合评价" byStar:self.starRating6 isAcc:NO withBlcok:nil];
...
- (void)addZgzsPicAction {
    ...
    if (self.arrZgzs.count >=2) {
        UIAlertView *alertAction = [[UIAlertView alloc] initWithTitle:@"温馨提示" message:@"最多添加两张评论图片" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles: nil];
        [alertAction show];
        return;
    }
