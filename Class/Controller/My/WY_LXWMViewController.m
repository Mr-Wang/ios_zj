...
@interface WY_LXWMViewController ()
...
@implementation WY_LXWMViewController
...
- (void)dataBind {
    ...
    NSMutableDictionary *dic2A = [NSMutableDictionary new];
...
//    [self.arrSource addObject:dic1];
    [self.arrSource addObject:dic2A];
...
//    [self.arrSource addObject:dic4];
    ...
    [dic1 setObject:@"CA业务1" forKey:@"name"];
    [dic1 setObject:@"13644978185" forKey:@"value"];
    [dic1 setObject:@"2" forKey:@"typeid"];
    
    [dic2A setObject:@"专家问题处理1" forKey:@"name"];
    [dic2A setObject:@"024-86082777" forKey:@"value"];
    [dic2A setObject:@"2" forKey:@"typeid"];
    
    [dic2 setObject:@"专家问题处理2" forKey:@"name"];
    [dic2 setObject:@"024-86786677" forKey:@"value"];
    [dic2 setObject:@"2" forKey:@"typeid"];
     
    [dic3 setObject:@"专家问题处理3" forKey:@"name"];
    [dic3 setObject:@"024-67781777" forKey:@"value"];
    [dic3 setObject:@"2" forKey:@"typeid"];
     
    [dic5 setObject:@"客服邮箱" forKey:@"name"];
    [dic5 setObject:@"lnwlzb@163.com" forKey:@"value"];
    [dic5 setObject:@"3" forKey:@"typeid"];
