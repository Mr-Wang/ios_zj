//
//  WY_BalanceDetailListViewController.m
...
@interface WY_BalanceDetailListViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_BalanceDetailListViewController
...
//    return;
     [[MS_BasicDataController sharedInstance] postWithURL:getAppCoinDetail_HTTP params:nil jsonData:nil showProgressView:YES success:^(id successCallBack) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WY_BalanceDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WY_BalanceDetailTableViewCell"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    WY_BalanceDetailTableViewCell *cell = [self tableView:tableView cellForRowAtIndexPath:indexPath];
    WY_TopUpModel *tempModel = self.arrDataSource[indexPath.row];
    [cell showCellByItem:tempModel];
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        [_tableView registerClass:[WY_BalanceDetailTableViewCell class] forCellReuseIdentifier:@"WY_BalanceDetailTableViewCell"];
