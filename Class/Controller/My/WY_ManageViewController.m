...
@interface WY_ManageViewController ()
{
    float lastY;
}
...
@implementation WY_ManageViewController
...
- (void)bindView {
    ...
    if (self.administrativePermissions == 1 || self.administrativePermissions == 3) {
        ...
        [imgview1 setImage:[UIImage imageNamed:@"0510_admin1"]];
    ...
    if (self.administrativePermissions == 1 || self.administrativePermissions == 2) { 
        ...
        [imgview2 setImage:[UIImage imageNamed:@"0510_admin2"]];
