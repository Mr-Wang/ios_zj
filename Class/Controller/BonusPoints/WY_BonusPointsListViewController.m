//
//  WY_BonusPointsListViewController.m
...
@interface WY_BonusPointsListViewController ()
...
@implementation WY_BonusPointsListViewController
...
- (void) makeUI {
    ...
    self.lblTopTitle.text = [NSString stringWithFormat:@"奖励加分：%@分",self.bonusPoints];
    ...
    [cancleButton setTitle:@"申请加分" forState:UIControlStateNormal];
    [cancleButton.titleLabel setFont:WY_FONT375Medium(12)];
    [cancleButton setBackgroundColor:[UIColor whiteColor]];
    [cancleButton setTitleColor:MSTHEMEColor forState:UIControlStateNormal];
    [cancleButton rounded:8];
...
- (void)dataSourceIndex{
    ...
    //奖励加分列表
    [[MS_BasicDataController sharedInstance] getWithReturnCode:zj_rewardApplyList_HTTP params:postDic jsonData:nil showProgressView:YES success:^(id res, NSString *code) {
        NSLog(@"获取数据成功");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell showCellSSByItem:tempModel];
