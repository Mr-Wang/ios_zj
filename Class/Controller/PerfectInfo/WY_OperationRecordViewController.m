//
//  WY_OperationRecordViewController.m
...
@interface WY_OperationRecordViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_OperationRecordViewController
...
- (void)dataSourceIndex{
    ...
    if([self.nsType isEqualToString:@"2"]) {
        nsUrlStr = zj_getApproval_HTTP;
        [postDic setObject:self.aexpertId forKey:@"id"];
    } else {
        nsUrlStr = expertGetExpertList_HTTP;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.nsType isEqualToString:@"2"]) {
        [cell showAddressCellByItem:tempModel];
    } else {
