//
//  WY_SelectJobTitle2ViewController.m
...
@interface WY_SelectJobTitle2ViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_SelectJobTitle2ViewController
...
- (void)dataSourceIndex{
    ...
    [postDic setObject:self.mModelOne.code forKey:@"code"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@-%@",self.mModelOne.name,tempModel.name];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    WY_ZJCompanyModel *tempModel = self.arrDataSource[indexPath.row];
    tempModel.jobTitleName = [NSString stringWithFormat:@"%@-%@",self.mModelOne.name,tempModel.name];
    tempModel.jobTitleCode = tempModel.code;
    if (self.selJobTitleBlock) {
        self.selJobTitleBlock(tempModel);
    }
