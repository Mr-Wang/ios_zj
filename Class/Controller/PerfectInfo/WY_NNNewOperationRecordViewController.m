//
//  WY_NNNewOperationRecordViewController.m
...
@interface WY_NNNewOperationRecordViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation WY_NNNewOperationRecordViewController
...
- (void)dataSourceIndex{
    ...
    NSString *nsUrlStr = zj_getExpertMainEvaluationList_HTTP; 
     [[MS_BasicDataController sharedInstance] postWithURL:nsUrlStr params:postDic jsonData:nil showProgressView:YES success:^(id successCallBack) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WY_CompleteStatusTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"WY_CompleteStatusTableViewCell"];
    ...
    cell.nsType = self.nsType;
        [cell showNNNewCellByItem:tempModel]; 
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    WY_CompleteStatusTableViewCell *cell = [self tableView:tableView cellForRowAtIndexPath:indexPath];
    WY_CompleteStatusModel *tempModel = self.arrDataSource[indexPath.row];
    cell.mUser = self.mUser;
    cell.nsType = self.nsType;
        [cell showNNNewCellByItem:tempModel];
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        [_tableView registerClass:[WY_CompleteStatusTableViewCell class] forCellReuseIdentifier:@"WY_CompleteStatusTableViewCell"];
