...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self initFSCalendarScrollViewWithFrame:frame withCalendarScrollViewHeight:frame.size.height-kCalendarHeaderViewHeight withShowSingle:NO withIspushToPreviousMonthOrNext:NO];
    }
    return self;
}

- (instancetype)initWithFrame:(CGRect)frame withIspushToPreviousMonthOrNext:(BOOL)ispushToPreviousMonthOrNext
{
    if (self = [super initWithFrame:frame]) {
          
          [self initCalendarHeaderViewWithFrame:frame withCalendarHeaderViewHeight:kCalendarHeaderViewHeight];
          [self initFSCalendarScrollViewWithFrame:frame withCalendarScrollViewHeight:frame.size.height-kCalendarHeaderViewHeight withShowSingle:NO withIspushToPreviousMonthOrNext:ispushToPreviousMonthOrNext];
      }
      return self;
}
- (instancetype)initWithFrame:(CGRect)frame withCalendarHeight:(CGFloat)calendarHeight withShowSingle:(BOOL)isShowSingle withIspushToPreviousMonthOrNext:(BOOL)ispushToPreviousMonthOrNext{
    
    if (self = [super initWithFrame:frame]) {
        
        [self initCalendarHeaderViewWithFrame:frame withCalendarHeaderViewHeight:kCalendarHeaderViewHeight];
        [self initFSCalendarScrollViewWithFrame:frame withCalendarScrollViewHeight:calendarHeight-kCalendarHeaderViewHeight withShowSingle:isShowSingle withIspushToPreviousMonthOrNext:ispushToPreviousMonthOrNext];
...
- (void)initFSCalendarScrollViewWithFrame:(CGRect)frame withCalendarScrollViewHeight:(CGFloat)calendarScrollViewHeight withShowSingle:(BOOL)isShowSingle withIspushToPreviousMonthOrNext:(BOOL)ispushToPreviousMonthOrNext{
    ...
    //设置是否支持滑动翻页
    self.calendarScrollView.scrollEnabled = ispushToPreviousMonthOrNext;
    //设置是否支持点击上下月翻页 -- 默认设置不支持
    self.calendarScrollView.ispushToPreviousMonthOrNext = NO;
...
#pragma mark ---- 通过日期跳转日历的方法 ----
- (void)refreshToByWithDate:(NSDate *)date {
    
    [self.calendarScrollView refreshToByWithDate:date];    
}
