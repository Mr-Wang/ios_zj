...
#define scaleValue (IS_IPhoneX_All?0.8:0.7)
...
- (void)viewDidLoad {
    ...
    [self.closeButton setImage:[ImageUtils getImageResourceForName:@"close"] forState:UIControlStateNormal];
    [self.closeButton addTarget:self action:@selector(closeAction) forControlEvents:UIControlEventTouchUpInside];
    self.closeButton.frame = CGRectMake(20, MH_APPLICATION_STATUS_BAR_HEIGHT + 20, 30, 30);
