    ...
    if (isScale) {
        ...
        [_imageCropperController setSubmitblock:^(UIViewController *viewController , UIImage *image) {
            if (picker.sourceType == UIImagePickerControllerSourceTypeCamera) {
                ...
                [viewController.presentingViewController.presentingViewController dismissViewControllerAnimated:YES completion:nil];
            }
...
//            UIImagePickerController *picker = (UIImagePickerController *)viewController.navigationController;
        ...
        [self.imageCropperController setModalPresentationStyle:UIModalPresentationFullScreen];
        
        if (picker.sourceType == UIImagePickerControllerSourceTypeCamera) {
            [picker pushViewController:self.imageCropperController animated:YES];
            
        }else{
            [picker presentViewController:self.imageCropperController animated:YES completion:nil];
        }
//        [picker pushViewController:self.imageCropperController animated:YES];
